...
public class CartService implements ICartService{
    ...
    public ServerResponse<CartVo> deleteProduct(Integer userId,String productIds){
        List<String> productLists = Splitter.on(",").splitToList(productIds);
        if (CollectionUtils.isEmpty(productLists)){
            return ServerResponse.createByErrorCodeMessage(ResponseCode.ILLEGAL_ARGUMENT.getCode(),ResponseCode.ILLEGAL_ARGUMENT.getDesc());
        }
        cartMapper.deleteByUserIdProducts(userId,productLists);
        return this.list(userId);
    }
    ...
    private CartVo getCartVoLimit(Integer userId){
        ...
        List<CartProductVo> cartProductVoLists = Lists.newArrayList();
        ...
        if (CollectionUtils.isNotEmpty(cartList)){
            for (Cart cartItem : cartList){
                ...
                cartProductVoLists.add(cartProductVo);
            }
        }
